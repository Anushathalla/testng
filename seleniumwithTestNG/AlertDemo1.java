...
public class AlertDemo1 
{
	...
	public void label() throws InterruptedException
	{
		...
		WebElement labelText = driver.findElement(By.xpath("//span[text()='Please enter the details for Print, Update, Cancel and Pre/Postpone Ticket.']")); 
		String actualData  = labelText.getText();
